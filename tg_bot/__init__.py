...
log.info("[Noha] Noha is starting. | An reven network Project. | Licensed under GPLv3.")
log.info("[noha] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[Noha] Project maintained by: github.com/Dank-del (t.me/dank_as_fuck)")

# if version < 3.6, stop bot.
if sys.version_info[0] < 3 or sys.version_info[1] < 7:
    log.error(
        "[Noha] You MUST have a python version of at least 3.7! Multiple features depend on this. Bot quitting."
    )
    quit(1)
...
class KigyoINIT:
    def __init__(self, parser: ConfigParser):
        ...
        self.bot_name = "sasuke" #placeholder
        self.bot_username = "SasukeUchiharobot" #placeholder
